...
export default async function LeaderboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link href="/discover" className="text-slate-600 hover:text-teal-600 font-medium transition-colors">
              Discover
            </Link>
            <Link href="/leaderboard" className="text-teal-600 font-semibold">
              Leaderboard
            </Link>
            <Link
              href="/"
      ...
      {/* Hero */}
      <div className="bg-gradient-to-r from-purple-500 to-indigo-500 text-white py-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-black mb-4">
            🏆 Leaderboard
          </h1>
          <p className="text-lg md:text-xl opacity-90 max-w-2xl mx-auto">
            Who's finding the most valuable treasures? Compete for the top spots!
          </p>
        </div>
      </div>
      ...
      <main className="max-w-6xl mx-auto p-4 sm:p-6 md:p-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            <h2 className="text-lg font-bold text-slate-800 mb-4 flex items-center gap-2">
              <span>💎</span> Biggest Single Finds
            </h2>
        ...
        <div className="mt-12 text-center">
          <p className="text-slate-600 mb-4">Want to climb the leaderboard?</p>
          <Link
            href="/"
