  ...
  return (
    <>
      ...
      <main className="max-w-4xl mx-auto p-4 sm:p-6 md:p-8">
        ...
        {/* Instagram-style Tab Navigation - Sticky */}
        <div className="sticky top-0 z-10 bg-white/80 backdrop-blur-md border-b border-slate-200 -mx-4 sm:-mx-6 md:-mx-8 px-4 sm:px-6 md:px-8 mt-4">
          <div className="flex">
            <button
