  ...
  return (
    <div className="min-h-screen px-4 py-8 max-w-lg mx-auto">
      ...
      <button
        ...
        className="sm:hidden flex flex-col justify-center items-center w-full px-4 py-10 border-2 border-dashed rounded-xl transition-colors min-h-[120px] border-red-500 bg-red-500/5 hover:bg-red-500/10 active:bg-red-500/20 disabled:opacity-50"
      >
      ...
      <input ref={cameraInputRef} type="file" accept="image/*" capture="environment" onChange={e => { handleFiles(e.target.files); e.target.value = ''; }} className="hidden" />
      <input ref={fileInputRef} type="file" multiple accept="image/*,.heic,.heif" onChange={e => { handleFiles(e.target.files); e.target.value = ''; }} className="hidden" />
